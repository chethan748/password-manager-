...
const Manager = () => {
  ...
  const getlabel = () => {
    ...
    return form.password ? labels[score] : "";
  };
    ...
    <div className="w-[90vw] mx-auto">
      ...
      <span className="flex flex-col p-2 w-full justify-center items-center content-center">
        ...
        <div className="flex-col flex gap-10 m-10 md:flex-row w-[100%] mx-auto justify-center items-center content-center">
          ...
          <span className="relative w-[100%]">
            <input
              className="border p-2 rounded-full w-[100%] pr-12"
        ...
        <div className="w-[85vw] md:w-[400px] mt-2">
          ...
          <p
            ...
            style={{
              color: getcolor().includes("red") ? "red" : "green",
            }}
          >
            {getlabel()}
          </p>
      ...
      <div>
        <div className="bg-teal-50 w-[90%] mx-auto rounded-3xl m-5 text-black">
          {password.length === 0 ? (
            <p className="text-slate-500 italic p-7">
              No passwords to display
            </p>
          ) : (
            <>
              <div className="text-3xl text-green-500 font-extrabold p-7">
                Passwords:
              </div>
              ...
              {password.map((item, index) => (
                <div
                  key={item._id}
                  className="pl-7 text-1.5xl font-bold"
                >
                  ...
                  <div>
                    <div className="flex gap-5 items-center">
                      ...
                      >
<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M360-240q-33 0-56.5-23.5T280-320v-480q0-33 23.5-56.5T360-880h360q33 0 56.5 23.5T800-800v480q0 33-23.5 56.5T720-240H360Zm0-80h360v-480H360v480ZM200-80q-33 0-56.5-23.5T120-160v-560h80v560h440v80H200Zm160-240v-480 480Z"/></svg>                      </button> 
                    </div>
...
<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M360-240q-33 0-56.5-23.5T280-320v-480q0-33 23.5-56.5T360-880h360q33 0 56.5 23.5T800-800v480q0 33-23.5 56.5T720-240H360Zm0-80h360v-480H360v480ZM200-80q-33 0-56.5-23.5T120-160v-560h80v560h440v80H200Zm160-240v-480 480Z"/></svg>                      </button>
                    ...
                    <button
                      className="bg-amber-300 text-white rounded w-17 h-8"
                      onClick={() => updatepass(item)}
                    >
                      Edit
                    </button>

                    <button
                      className="bg-amber-300 text-white rounded w-17 h-8 m-5"
                      onClick={() => deletepass(item)}
                    >
                      Delete
                    </button>
                  </div>
